...
export default function VisionPage() {
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-[var(--green)] text-white py-10 lg:py-14">
        <div className="max-w-[960px] mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg leading-relaxed max-w-2xl opacity-90">
            ...
            corruption or delay. This is what universal digital services looks
            like.
          </p>
        </div>
      </section>
            ...
            {timeline.map((stage, stageIdx) => (
              <div key={stageIdx} className="mb-10 last:mb-0">
                ...
                <div className="relative flex items-center gap-4 mb-4">
                  ...
                  <h2 className="text-lg font-bold text-[var(--black)] uppercase tracking-wider">
                    {stage.stage}
                  </h2>
                </div>
